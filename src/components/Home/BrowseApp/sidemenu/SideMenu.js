   ...
   <div className='sidemenu-bar'>
        ...
        <div className='sidemenu-contents'>
            ...
            <div onClick={(event)=>{navigate('/Browse-Apps')}}>
                <p className='sidemenu-items hover'><TiTabsOutline  className='sidemenu-icons' /> <span className='p-content'> Browse Apps </span></p>
            </div>
            <div onClick={(event)=>{navigate('/Profile')}}>
                <p className='sidemenu-items '> <CgProfile  className='sidemenu-icons' /><span className='p-content'> Profile </span></p>
            </div> 
             
            <div >
                <p className='sidemenu-items ' onClick={(event)=>{navigate('/Notifications')}}> <RiNotificationLine  className='sidemenu-icons' /> <span className='p-content'> Notifications </span></p>
            </div>
            <div>
            <p className='sidemenu-items' onClick={(event)=>{navigate('/Settings')}} > <FiSettings  className='sidemenu-icons'/><span className='p-content'> Settings </span> </p>
            </div>
        </div>
